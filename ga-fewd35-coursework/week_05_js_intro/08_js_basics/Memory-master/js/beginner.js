//Define a variable here called "animals" that is equal to an array with 6
//different animals repeated once each. You should have a total of 12 animals.

var animals = ["Dog", "Cat", "Lizard", "Kangaroo", "Octopus", "Tiger", "Dog",
"Cat", "Lizard", "Kangaroo", "Octopus", "Tiger"];
...
function checkWin() {
	if (pickedAnimals.length === 2) {
		if (pickedAnimals[0].animal === pickedAnimals[1].animal) {
			...
			alert("The animals selected do no match!");
